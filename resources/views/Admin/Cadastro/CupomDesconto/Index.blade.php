            ...
            <div class="px-2 pt-2">	
				  ...
				  <div class="rows">
                        ...
                        <div class="col-2">	
                                ...
                                <input type="text" name="valor_desconto" value="{{isset($cupomdesconto->valor_desconto) ? $cupomdesconto->valor_desconto: null}}"  class="form-campo mascara-float">
                        </div>
				  		
				  		<div class="col-2">	
                                <label class="text-label d-block text-branco">Percento (%) </label>
                                <input type="text" name="percentual_desconto" value="{{isset($percentual_desconto->valor_desconto) ? $cupomdesconto->percentual_desconto: null}}"  class="form-campo mascara-float">
                        </div>	
                         <div class="col-2">	
                    ...
                    <table cellpadding="0" cellspacing="0" id="dataTable" width="100%">
                          ...
                          @foreach($lista as $cat)                                     
                             <tr>
                                ...
                                <td align="left">{{$cat->valor_desconto}}</td>	
                                <td align="left">{{$cat->percentual_desconto}}</td>	
