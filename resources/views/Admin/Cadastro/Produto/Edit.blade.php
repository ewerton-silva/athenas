                               ...
                               <div class="col-3 mb-3">
                                ...
                                <div class="col-3 mb-3">
        				   		...
        				   		<div class="col-3 mb-3">
                                        ...
                                        <input type="text" name="valor_venda" id="valor_venda" onkeyup="calcularMargem()" required value="{{isset($produto->valor_venda) ? $produto->valor_venda : old('valor_venda')}}"  class="form-campo  mascara-float">
                                </div>
                                <div class="col-3 mb-3">
