					...
					<div class="rows">
						...
						<div class="col-3 d-flex">
							...
							<div class="card-stretch">
								@if($g->path)
								<img src="{{asset('storage/upload/imagens_produtos/'.$g->path)}}" class="img-fluido">
								@else
								<img src="{{asset('storage/upload/no_image.png')}}" alt="image"  class="img-fluido">
								@endif
								<a href="{{route('deliveryproduto.excluirImagem',$g->id)}}" class="btn btn-vermelho btn-circulo" title="Remover">
