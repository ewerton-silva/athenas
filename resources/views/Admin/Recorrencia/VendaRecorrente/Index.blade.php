...
<div class="rows">	
                ...
                <div class="caixa">
					...
					<span class="d-flex center-middle h5 mb-0"><i class="far fa-list-alt mr-1"></i> Lista de Venda Recorrente </span>
						<div>
		...
		<div class="col-12">
				...
				<div class="px-2">
					...
					<div class="col">
						...
						<table cellpadding="0" cellspacing="0" id="dataTable" width="100%">
							   ...
							   @endphp                                      
								 <tr>
									...
									<td align="right">
										<a href="javascript:;" onclick="abrir_opcoes_vendarecorrente({{$c->id}})" ><i class="ellipsis-vertical"></i></a>
									</td>
								 </tr>
						...
						<div class="col-2 MostraOpcoes" id="opcoes_vendarecorrente">
							<ul class="cx-opcoes" >
								<li>Ordem de Serviço:<span id="id_vendarecorrente"></span></li>								
								<li class="concreto"><a href="javascript:;" onclick="editarVenda()"><i class="fas fa-eye"></i> Ver/Editar</a></li>
								<li class="concreto"><a href="javascript:;" onclick="inserirCobranca()"><i class="fas fa-eye"></i> Inserir Cobranças</a></li>
